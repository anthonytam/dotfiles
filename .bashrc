...
# Add GCC compiler arguments with output file
function compileC() {
	outputFile=$(basename $1 | cut -d. -f1)
	gcc -Wall $1 -o ${outputFile}.out
}
alias c=compileC

# Add a go back command to go back to previous folder
